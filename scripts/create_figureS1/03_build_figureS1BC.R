# ==============================================================================
# Script: Build Figure S1B and S1C - Venn Diagram and UpSet plot
...
# ==============================================================================
# Figure S1B: Create Venn Diagram
# ==============================================================================
...
saveViz(venn,
        output_dir = here("output", "figureS1"),  # Output directory
        output_file = "figS1B_example_venn",      # Filename (without extension)
        with_date = FALSE,                        # Don't append date to filename
        width = 4,                                # Width in inches
        height = 2.5)                             # Height in inches

# ==============================================================================
# Figure S1C: Create UpSet plot
# ==============================================================================
...
saveViz(upset,
        output_dir = here("output", "figureS1"),  # Output directory
        output_file = "figS1C_example_upset",     # Filename (without extension)
        with_date = FALSE,                        # Don't append date to filename
