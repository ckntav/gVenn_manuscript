# ==============================================================================
# Script: Build Figure S1A - Genomic Track Visualization
...
# Note:    The disjoint regions and overlap groups plotted here come from
#          gVenn::computeOverlaps() run in "disjoin" mode (script 01), which is
...
output_file <- paste(sep = "_", "figS1A", chr_i, start_i, end_i)
...
output_dir <- here("output", "figureS1")
...
# ==============================================================================
# Plot Disjoint Regions (Elementary Non-Overlapping Intervals)
# ==============================================================================
# Show all regions that contain at least one peak, cut at every peak boundary
disjoint_regions <- rtracklayer::import(here("output", "overlaps_disjoint_bed", "example_disjoint_regions.bed"))

# Add an alternating id so adjacent regions get different colors
GenomicRanges::mcols(disjoint_regions)$region_id <- seq_along(disjoint_regions) %% 2

plotRanges(data = disjoint_regions, params = params_i,
           y = "0.15b", height = 0.065,
           linecolor = NA,
           collapse = TRUE,
           fill = colorby("region_id", palette = colorRampPalette(c("#303030", "#D3D3D3"))))
plotText(label = "disjoint regions", x = 0.45, y = "-0.035b", fontsize = fontsize_val-2, just = "right")
...
plotRanges(data = here("output", "overlaps_disjoint_bed", "example_disjoint_group_111.bed"), params = params_i,
           y = "0.15b", height = 0.065,
...
plotRanges(data = here("output", "overlaps_disjoint_bed", "example_disjoint_group_110.bed"), params = params_i,
           y = "0.03b", height = 0.065,
...
plotRanges(data = here("output", "overlaps_disjoint_bed", "example_disjoint_group_101.bed"), params = params_i,
           y = "0.03b", height = 0.065,
...
plotRanges(data = here("output", "overlaps_disjoint_bed", "example_disjoint_group_011.bed"), params = params_i,
           y = "0.03b", height = 0.065,
...
plotRanges(data = here("output", "overlaps_disjoint_bed", "example_disjoint_group_100.bed"), params = params_i,
           y = "0.03b", height = 0.065,
...
plotRanges(data = here("output", "overlaps_disjoint_bed", "example_disjoint_group_010.bed"), params = params_i,
           y = "0.03b", height = 0.065,
...
plotRanges(data = here("output", "overlaps_disjoint_bed", "example_disjoint_group_001.bed"), params = params_i,
           y = "0.03b", height = 0.065,
...
# ==============================================================================
# The disjoint regions and the overlap groups above are derived from
# computeOverlaps() run in "disjoin" mode (see Figure 1A for "reduce" mode)
plotText(label = 'computeOverlaps(mode = "disjoin")',
...
# 3. Disjoint regions, alternating shades to separate adjacent intervals
# 4. Seven overlap groups color-coded by presence/absence pattern
# ==============================================================================
