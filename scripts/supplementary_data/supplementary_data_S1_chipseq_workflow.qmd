...
format:
  html:
    ...
    include-in-header:
      - text: |
            <link rel="icon" type="image/png" href="img/venn_logo.png">
      - text: |
...
Following Micallef and Rodgers (2014), who introduced `diagError`, a diagram is considered accurate when it draws every non-empty region and its `diagError` does not exceed 10⁻⁶, the threshold the message reports against. Here diagError is `r signif(attr(venn, "fit_diagnostics")$diagError, 2)` and no region is undrawn.
