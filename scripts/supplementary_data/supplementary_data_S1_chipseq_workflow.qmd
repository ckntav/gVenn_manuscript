...
The message above reports `eulerr`'s goodness-of-fit diagnostics for this layout. `plotVenn()` also attaches them to the object it returns, together with the per-region errors:
