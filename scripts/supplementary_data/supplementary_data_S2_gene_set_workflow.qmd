...
Each gene is assigned a category code representing its overlap pattern. The number of genes per pattern is given in [Extracting overlap groups](#extracting-overlap-groups).
