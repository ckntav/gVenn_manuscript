...
# mode = "reduce" (the default) merges overlapping regions within each set before
# intersecting them, so each region is assigned to a single overlap combination
# (see Figure S1 for the alternative "disjoin" mode)
